...
function formatQuote(aphorism) {
    ...
    // return aphorism.quote
    // console.log(aphorism[0].quote + " " + "-" + aphorism[0].author );
...
// and returns a string that contains a random quote
...
function getRandomQuote(aphorism) {
    ...
    // console.log(aphorism[i].quote + " " + "-" + aphorism[i].author);
...
function fiveRandomQuotes(aphorismsArray) {
    ...
    for (var a = 0; a < 5; a++){
        ...
        var randomQuotesObjects = {};

        randomQuotesObjects.aphorism = aphorisms[i];

        randomQuotesArray.push(randomQuotesObjects);

        // ==== Log this one to show 5 random quotes
        console.log(randomQuotesArray[a].aphorism.quote + " " + "-" + randomQuotesArray[a].aphorism.author);

        // var fiveRandom = randomQuotesArray[a].aphorism.quote + " " + "-" + randomQuotesArray[a].aphorism.author;
...
// that accepts the aphorisms array √
// and returns an array of aphorism objects of all quotes by 'anonymous'. Each object should contain the following properties: { quote: <QUOTE_HERE>, author: <AUTHOR_HERE>}.
